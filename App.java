...
public class App {
    public static void main(String[] args) {
        ...
        if (system.getAllStudents().isEmpty()) {
            ...
            SimpleDatabaseHandler.createSampleData();
            system = new StudentSystem(); // Reload with sample data
        }
            ...
            switch (choice) {
                case 1:     // Add Student
                    while (true) {
                        ...
                        System.out.println(" 1. Add Student from Database.");
                        ...
                        switch (addChoice) {
                            case 1:         // Add Student from Database
                                system.mergeStudentSystem(SimpleDatabaseHandler.loadStudentsFromDatabase());
                                break;
                ...
                case 5:             // List and Sort Students
                    while (true) {
                        ...
                        else if (outputChoice == 2) {       // Output to Database
                            SimpleDatabaseHandler.saveAllStudentsToDatabase(system);
                            break;
                        }
